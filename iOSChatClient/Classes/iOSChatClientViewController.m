...
- (void)getNewMessages {
	NSString *url = [NSString stringWithFormat:@"http://localhost:8888/messages.php?past=%d&t=%ld",
					 lastId, time(0) ];
...
- (IBAction)sendClicked:(id)sender {
	...
	if ( [messageText.text length] > 0 ) {
		...
		NSString *url = [NSString stringWithFormat:@"http://localhost:8888/add.php"];
